...
def decision_tree(interval, get_number_intervals, directory_train, directory_test, method, show):
    """
            Функция для обучения и предсказания данных по классификатору decision tree
    ...
    parametrs = {'criterion': ['gini', 'entropy'], 'max_depth': range(1, 40, 3),
    ...
    # print(f"Должны: {x_res}")
    # print(f"Получились: {res}")
